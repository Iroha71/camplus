...
漁船に散らばる網のようにコードが散らばっている部屋、[r]と言えば似ていないこともないかもしれないが、まあ似ていない。[p]
[_tb_end_text]
...
念のためその手を取って部屋の中心にあった机と椅子まで導くと、[r]ひーさんは露骨にほっとして息を漏らした。[p]
...
咄嗟に背中に腕を伸ばし、後ろに倒れることは阻止できた。[r][l]……が、どうやら守られたのはサーバだったようだ。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#
そのまま床に座らせることも考えたが、本当にぎっくり腰だった場合のことを[r]考えて横にさせる。[p]
……とはいえ、どうすればいいのだろうか？[p]
...
[tb_start_text mode=1 ]
#
急に呼び出されたにもかかわらず、「いたいのいたいのとんでいけ」で[r]なんとか痛みが治まったらしい。[p]
ひーさんが無事に椅子に座ったのを確認し、[r]慣れたようにそそくさと戻っていったヨウコという生徒会役員を見送る。[p]
実際に「いたいのいたいのとんでいけ」で痛みがとんでいってしまったり、[p]
ヨウコが机の上に置いていたぬいぐるみの腹が[r]突然弾け飛んでしまったりしたが、深く考えないことにした。[p]
ひーさんの腰の痛みが引いて見学が続行できるならこの際何でもいい。[p]
[_tb_end_text]

[jump  storage="ed2.ks"  target="*ed2"  cond="f.HP==0"  ]
[jump  storage="h2_6.ks"  target="*common1"  ]
*周囲を観察する
...
床の穴に向けて伸びているコードは広がってこそいないものの、[r]ここをひーさんが通れば間違いなくひっかかるだろうなというたわみ方をしていた。[p]
[_tb_end_text]
...
口から咄嗟に謝罪の言葉が出てきたが、不安定な体勢でそんなことをしてたら[r]またバランスを崩しそうなので、早いところ椅子に座ってほしい。[p]
[_tb_end_text]
...
転ぶこともぎっくり腰になることもないし、知識までもたらしてくれるのだから、[r]正直もうひーさんより遙かに頼もしい。[p]
スマートフォンに関しては散々ひーさんの転倒に付き合わされたり[r]落下の憂き目にあったりしているので、労りたいくらいである。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#
何かわかる言葉はあるか、[r]とひーさんがパンフレットを開いてこちらに向けてくる。[p]
[_tb_end_text]
