...
[tb_start_text mode=1 ]
確かに目に入ったスマートフォンの画面は、形や整然と、片や雑然としていて[r]一人の人物が使っているとするとかなり違和感のあるものだ。[p]
最初だけ会長が設定などをしたというのなら、[p]会長の手から離れた後はひーさんではない他の誰かの手で[r]アプリが増えるだけ増えて整理もされずにいたのだろう。[p]
...
[tb_start_text mode=1 ]
#ひーさん
「片仮名多くない？　なんじゃこの、阿闍梨（あじゃり）開発演習って」[p]
[_tb_end_text]
...
スマートフォンは机から飛び出し、[r]運悪く伸ばされていたひーさんの脚に、更に運悪く直撃した。[p]
[_tb_end_text]
...
あまりにもあんまりなので、大丈夫かと気遣うために出した自分の声も若干震えている気がする。[p]
[_tb_end_text]
...
[chara_hide  name="ひーさん"  time="500"  wait="true"  pos_mode="true"  ]
[tb_start_text mode=1 ]
そう言ってひーさんはスマートフォンをぽいっと渡すと、[r]教室の奥へふらりと向かっていく。[p]
...
[tb_image_show  time="1000"  storage="default/ASO_Phone.png"  width="239"  height="503"  x="544"  y="8"  _clickable_img=""  ]
...
[tb_image_hide  time="1000"  ]
[chara_show  name="ひーさん"  time="800"  wait="true"  storage="chara/2/ひーさん(通常).png"  width="804"  height="1122"  left="270"  top="114"  ]
[tb_start_text mode=4 ]
#ひーさん
「ふぅ、生き返った心地じゃ。
[_tb_end_text]
