...
[glink  color="black"  storage="h2_2.ks"  size="20"  text="緑茶"  target="*緑茶"  ]
[glink  color="black"  storage="h2_2.ks"  size="20"  text="コーヒー"  target="*コーヒー"  ]
[glink  color="black"  storage="h2_2.ks"  size="20"  text="紅茶"  target="*紅茶"  ]
...
はい[p]
#ひーさん
なんじゃその反応！？もしかして転校生は運動が出来るたいぷか！？裏切者か！？[p]
