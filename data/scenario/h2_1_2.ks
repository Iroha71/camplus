...
[chara_show  name="会長"  time="500"  wait="true"  storage="chara/1/会長（通常‐kuchi_）.png"  width="1077"  height="1521"  left="484"  top="95"  reflect="false"  ]
[tb_show_message_window  ]
[tb_start_text mode=1 ]
#会長
私から生徒会役員には連絡しておくから[r]好きな館に行きなさい。[p]
大丈夫だろうけど迷わないように。[l][r]時間の無駄だから。[p]
#
[_tb_end_text]
...
[tb_show_message_window  ]
[tb_start_text mode=1 ]
一号館に向かい、ようやくその建物の入り口に辿り着こうというところで、[r]そこに誰かがいるのが見えた。[p]手元を覗き込みながら右往左往している[p]
[_tb_end_text]

[chara_show  name="ひーさん"  time="500"  wait="true"  storage="chara/2/ひーさん（緊迫）.png"  width="645"  height="906"  left="1257"  top="376"  reflect="false"  ]
[tb_start_text mode=1 ]
#???
...
[chara_show  name="ひーさん"  time="500"  wait="true"  storage="chara/2/ひーさん（困り）.png"  width="1122"  height="1587"  left="449"  top="306"  reflect="false"  ]
[tb_start_text mode=1 ]
#???
...
[tb_start_text mode=1 ]
色々と気になることも言っていたが、反射的に目の前に差し出されたスマートフォンを掴んで画面を見る。[p]さっきの言葉が本当なら目の前の人物はメールを確認しようとしていたはずだが、[r]何故か開いていたのは地図アプリの上にカーソルが示しているのはインド洋だ。[p]何がどうしてそうなったのは分からないものの、[r]なるべく内容を見ないように通知センターを開いて相手にスマートフォンを返す。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
相手が随分と小柄なので、背を丸めてスマートフォンの画面に顔を近付けていると顔が見えない。[p]そんな状態の子の人が見ている連絡が会長ーーー[wait time=500][r]生徒会長からの連絡だとすると、彼女が一号館を担当している生徒会役員なのだろうか。[p]
[_tb_end_text]
...
[chara_mod  name="ひーさん"  time="600"  cross="true"  storage="chara/2/ひーさん(通常).png"  ]
[tb_start_text mode=1 ]
腕をぶんぶん振り、ぴょんぴょんとこっち飛び跳ねるーーー[wait time=500]のではなく、[l][r]手をちょいちょいと動かしてこちらに声をかけてくる。[p]

[_tb_end_text]

[chara_hide  name="ひーさん"  time="500"  wait="true"  pos_mode="true"  ]
[chara_show  name="ひーさん"  time="1000"  wait="true"  storage="chara/2/ひーさん（喜ー口閉じ）.png"  width="1122"  height="1587"  left="449"  top="306"  reflect="false"  ]
[tb_start_text mode=3 ]
#???
転校生！[wait time=1000][r]
[_tb_end_text]
...
[mask_off  time="1000"  effect="fadeOut"  ]
[tb_show_message_window  ]
[chara_show  name="ひーさん"  time="600"  wait="true"  storage="chara/2/ひーさん(通常).png"  width="1122"  height="1587"  left="449"  top="306"  ]
[tb_start_text mode=3 ]
#???
...
[tb_start_text mode=1 ]
腰に手を当て、胸を張って自己紹介をされる。[l][r]薄々感じてはいたが、見た目からは中々想像が付かない古風な話し方をする人だ。[p]そう動きが大きいわけではないはずなのに、[r]たっぷりとした薄い紫色の髪がよく動くので[p]口数がそれなりに多いことと合わさって随分賑やかな人に感じる[p]
[_tb_end_text]
...
[chara_show  name="ひーさん"  time="600"  wait="true"  storage="chara/2/ひーさん（喜）.png"  width="1122"  height="1587"  left="449"  top="306"  ]
...
[chara_mod  name="ひーさん"  time="600"  cross="true"  storage="chara/2/ひーさん(通常).png"  ]
[tb_start_text mode=1 ]
いやあワシくらいになるとこういうのは全然覚えられんし、[l][r]正直用語も何もわかっとらんからのぉ[p]
#
[_tb_end_text]
...
[chara_show  name="会長"  time="1000"  wait="true"  storage="chara/1/会長（通常‐kuchi_）.png"  width="1077"  height="1521"  left="484"  top="95"  reflect="false"  ]
[tb_show_message_window  ]
[tb_start_text mode=1 ]
#会長
...
[mask_off  time="500"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
……なるほど、[wait time=250]会長が苦労するわけだ。[p]あの言い方からすると会長もこの状態はある程度予想していそうだが、[l][r]このことは頭に留めておこう[p]
[_tb_end_text]

[chara_mod  name="ひーさん"  time="600"  cross="true"  storage="chara/2/ひーさん（怒）.png"  ]
[tb_start_text mode=2 ]
#ひーさん
なんじゃその、初手からちょっと駄目だなこの人、みたいな顔は。[l][r]
[_tb_end_text]
...
ネットワーク・セキュリティ分野。[p]
電子システム分野。[p]
並べられた三つの分野の下にビジネス分野というものもあるが、[l][r]少し系統が違うらしく、とりあえず今は外して説明を進めていくようだ。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#ひーさん
いかん、転校生。[l][r]どこかの教室に入ろう。[p]いや入らなくてもいいから椅子に座ろう。[l]今すぐに[p]
#
[_tb_end_text]
