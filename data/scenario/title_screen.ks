...
[chara_show  name="タイトル"  time="2000"  wait="false"  storage="chara/4/rogo.png"  width="700"  height="239"  left="308"  top="236"  reflect="false"  ]
[wait  time="3000"  ]
...
[chara_show  name="タイトル"  time="1450"  wait="true"  storage="chara/4/inuboku.png"  width="1051"  height="552"  left="-69"  top="227"  reflect="false"  ]
...
[button  storage="title_screen.ks"  target="*start"  graphic="title/inuboku_(5).png"  width="352"  height="184"  name="img_21"  x="228"  y="320"  _clickable_img=""  ]
[button  storage="title_screen.ks"  target="*load"  graphic="title/inuboku_(4).png"  width="334"  height="175"  x="240"  y="419"  _clickable_img=""  name="img_22"  ]
[s  ]
*start
